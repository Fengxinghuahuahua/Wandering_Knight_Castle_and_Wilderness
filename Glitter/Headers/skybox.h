...
private:
    ...
    Shader skyShader = Shader("skybox.vert", "skybox.frag");

    float cubeVertices[180] = { // ȷ������������ʱ�붨��ￄ1�7
        // Back face�����棬���ӽǿ��Ļ���˳ʱ��˳����Ⱦ�ģ�ʵ��������ʱ�붨��ￄ1�7
        ...
        // Front face�����棬���ӽǿ��Ļ�����ʱ����Ⱦ�ģ�ʵ����Ҳ����ʱ�붨��ￄ1�7
        -0.5f, -0.5f,  0.5f,  0.0f, 0.0f, // bottom-left
         0.5f, -0.5f,  0.5f,  1.0f, 0.0f, // bottom-right
         0.5f,  0.5f,  0.5f,  1.0f, 1.0f, // top-right
         0.5f,  0.5f,  0.5f,  1.0f, 1.0f, // top-right
